...
struct AsyncThumbnailView: View {
    ...
    var body: some View {
        let imageToDisplay = UIImage(cgImage: imageStore.thumbnailImage.cgImage!, scale: imageStore.thumbnailImage.scale, orientation:UIImage.Orientation.up  )
...
struct AsyncImageView: View {
    ...
    var body: some View {
        let imageToDisplay = UIImage(cgImage: imageStore.image.cgImage!, scale: imageStore.image.scale, orientation:UIImage.Orientation.up  )
